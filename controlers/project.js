'use strict'
//Un controlador es una especie de clase
//que va a tener una serie de metodos
//o de acciones que va a poder hacer
//relacionado con las entidades del proyecto
...
var controller = {
    ...
    deteleProject: function (req, res) {
        var projectId = req.params.id;
        Project.findByIdAndRemove(projectId, (err, projectRemoved) => {
            ...
            if (!projectRemoved) return res.status(404).send({
                message: "No se puede borrar ese proyecto"
            });
            return res.status(200).send({
    ...
    uploadImage: function (req, res) {
        ...
        if (req.files) {
			...
			return res.status(200).send({
				message: fileName//No entra el req.files
			});
		}
